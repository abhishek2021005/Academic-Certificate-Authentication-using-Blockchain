window.CONTRACT = {
  address: '0x19e83325e25b2481A6dfE227343DF9fEe744eCcf',
  network: 'http://localhost:7545',
  explore: 'http://localhost:7545',
   abi: [
	{
		"inputs": [
			{
...
//note: if we r using local server we need to replace 127.0.0.1 with your machine local ip address got from the router
